 ...
 */
#ifndef _TIBEE_ANALYSISBLOCKS_LINUXSTATUSBUILDERBLOCK_HPP
#define _TIBEE_ANALYSISBLOCKS_LINUXSTATUSBUILDERBLOCK_HPP
...
/**
 * Linux status builder block.
 *
 * @author Francois Doray
 */
class LinuxStatusBuilderBlock : public block::AbstractBlock
{
public:
    LinuxStatusBuilderBlock();
