 ...
 */
#ifndef _TIBEE_ANALYSIS_EXECUTIONGRAPH_NODEPAIR_HPP
#define _TIBEE_ANALYSIS_EXECUTIONGRAPH_NODEPAIR_HPP
...
template <>
struct hash<tibee::analysis::execution_graph::NodePair> {
    size_t operator()(const tibee::analysis::execution_graph::NodePair& node_pair) const {
...
#endif    // _TIBEE_ANALYSIS_EXECUTIONGRAPH_NODEPAIR_HPP